...
uint32_t GroupSyncRead::getData(uint8_t id, uint16_t address, uint16_t data_length) {
    ...
    switch (data_length) {
        ...
        case 4:
            return DXL_MAKEDWORD(DXL_MAKEWORD(data_list_[id][address - start_address_ + 0],
                                              data_list_[id][address - start_address_ + 1]),
                                 DXL_MAKEWORD(data_list_[id][address - start_address_ + 2],
                                              data_list_[id][address - start_address_ + 3]));
